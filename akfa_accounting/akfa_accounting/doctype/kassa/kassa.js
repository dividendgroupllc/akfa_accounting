...
frappe.ui.form.on("Kassa", {
    ...
    refresh: function(frm) {
        ...
        if (window._akfa_kassa_restricted === undefined) {
            frappe.call({
                method: "akfa_accounting.akfa_accounting.doctype.kassa.kassa.is_company_restricted_user",
                callback: function(r) {
        ...
        frm.set_query("expense_account", function() {
            return {
                query: "akfa_accounting.akfa_accounting.doctype.kassa.kassa.get_expense_accounts",
                filters: {
    ...
    mode_of_payment: function(frm) {
        if (frm.doc.mode_of_payment && frm.doc.company) {
            frappe.call({
                method: "akfa_accounting.akfa_accounting.doctype.kassa.kassa.get_cash_account_with_currency",
                args: {
    ...
    update_balance: function(frm) {
        if (frm.doc.cash_account && frm.doc.company) {
            frappe.call({
                method: "akfa_accounting.akfa_accounting.doctype.kassa.kassa.get_account_balance",
                args: {
    ...
    set_mode_of_payment_query: function(frm) {
        frm.set_query("mode_of_payment", function() {
            ...
            if (frm.doc.transaction_type === "Конвертация") {
                return {
                    query: "akfa_accounting.akfa_accounting.doctype.kassa.kassa.conversion_mode_of_payment_query",
                    filters: {
                        company: frm.doc.company
                    }
                };
            ...
            return {
                query: "akfa_accounting.akfa_accounting.doctype.kassa.kassa.company_mode_of_payment_query",
                filters: {
                    company: frm.doc.company
                }
            };
    ...
    set_mode_of_payment_to_query: function(frm) {
        frm.set_query("mode_of_payment_to", function() {
            ...
            if (frm.doc.transaction_type === "Перемещения") {
                return {
                    query: "akfa_accounting.akfa_accounting.doctype.kassa.kassa.transfer_mode_of_payment_query",
                    filters: {
                        company: frm.doc.company,
                        source_mode_of_payment: frm.doc.mode_of_payment
                    }
    ...
    fetch_exchange_rate: function(frm) {
        ...
        frappe.call({
            method: "akfa_accounting.akfa_accounting.doctype.kassa.kassa.get_exchange_rate",
            args: {
    ...
    party: function(frm) {
        if (frm.doc.party && frm.doc.party_type) {
            ...
            if (in_list(["Customer", "Supplier", "Employee"], frm.doc.party_type)) {
                frappe.call({
                    method: "akfa_accounting.akfa_accounting.doctype.kassa.kassa.get_party_currency",
                    args: {
